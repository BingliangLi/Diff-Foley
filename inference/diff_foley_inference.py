...
def generate_audio_sample(video_path, save_path):
    ...
    for i in range(window_num):
        ...
        if use_double_guidance:
            audio_samples, _ = latent_diffusion_model.sample_log_with_classifier_diff_sampler(
                ...
                classifier_guide_scale=cg_scale
            )  # Double Guidance
        else:
            audio_samples, _ = latent_diffusion_model.sample_log_diff_sampler(
                embed_cond_feat,
